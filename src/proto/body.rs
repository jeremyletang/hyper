...
impl Body {
    ...
    pub(crate) fn delayed_drop(&mut self, val: Box<Send>) {
        debug_assert!(self.delayed_drop.is_none());
        self.delayed_drop = Some(val);
    }
